      ...
      <div className="bg-white dark:bg-gray-900 overflow-x-hidden font-sans">
        ...
        <section className="relative min-h-[90vh] flex items-center bg-white dark:bg-gray-900 overflow-hidden pt-10 md:pt-0">
          <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-300 font-bold text-sm tracking-wide uppercase">
              ...
              <motion.div variants={itemVariants} className="flex flex-wrap gap-6 text-gray-600 dark:text-gray-300 font-medium">
                <div className="flex items-center gap-2">
                   <FiCheckCircle className="text-purple-600 text-xl" /> Expert-led courses
                </div>
                <div className="flex items-center gap-2">
                   <FiCheckCircle className="text-purple-600 text-xl" /> Lifetime access
                </div>
                <div className="flex items-center gap-2">
                   <FiCheckCircle className="text-purple-600 text-xl" /> Certificate included
                </div>
              </motion.div>

              <motion.div variants={itemVariants} className="flex flex-wrap gap-4 pt-4">
                <Link to="/courses">
                  <button className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white text-lg font-bold py-4 px-8 rounded-full shadow-xl hover:shadow-purple-500/30 transition-all transform hover:-translate-y-1">
                    Start Learning Free <FiArrowRight />
                  </button>
                </Link>
                <button
                  onClick={() => setIsDemoOpen(true)}
                  className="flex items-center gap-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-white border border-gray-200 dark:border-gray-700 hover:border-purple-200 hover:bg-purple-50 dark:hover:bg-gray-700 text-lg font-bold py-4 px-8 rounded-full transition-all shadow-sm hover:shadow-md"
                >
                  <FiPlayCircle className="text-purple-600 text-xl" /> Watch Demo
                </button>
              </motion.div>
            </motion.div>
            ...
            >
               {/* Abstract Blobs */}
              <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-purple-200/50 dark:bg-purple-900/20 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
              <div className="absolute bottom-0 left-10 w-[400px] h-[400px] bg-pink-200/50 dark:bg-pink-900/20 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000"></div>
        ...
        <section className="py-20 bg-white dark:bg-gray-900">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                { value: totalCourses || 0, label: "Online Courses", icon: <FiBook />, color: "bg-purple-100 text-purple-600" },
                { value: allUsersCount || 0, label: "Active Learners", icon: <FiUsers />, color: "bg-blue-100 text-blue-600" },
              ].map((stat, idx) => (
                <motion.div
                  key={idx}
                  ...
                  className="p-8 rounded-3xl bg-gradient-to-br from-purple-600 to-indigo-600 text-white shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 flex flex-col items-center justify-center text-center space-y-4"
                >
        ...
        <section className="py-24 bg-white dark:bg-gray-900">
          <div className="container mx-auto px-6">
            <div className="mb-12 text-center">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-bold text-sm tracking-wide uppercase mb-3">
                <FaBookOpen />
                My Courses
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {myCourses?.length > 0 ? (
                      ...
                      >
                        <div className="relative overflow-hidden h-44">
                          ...
                          <div className="absolute top-3 left-3">
                            <span className="px-2 py-1 bg-blue-600 text-white text-xs font-medium rounded-md shadow-sm">
                              {course?.category}
                            </span>
                          </div>
                        ...
                        <div className="p-5 flex flex-col flex-grow">
                          ...
                          <Link to="/course/displaylectures" state={{ ...course }}>
                            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-4 rounded-lg transition-colors duration-200 text-sm flex items-center justify-center gap-2 mt-auto">
                  ...
                  <div className="col-span-full text-center py-12">
                    ...
                    <Link to="/courses">
                      <button className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2.5 px-6 rounded-full transition-all">
                        Browse Courses
                      </button>
                    </Link>
                  </div>
        ...
        <section className="py-24 px-6 bg-white dark:bg-gray-900">
          <div className="container mx-auto">
            <div className="relative rounded-[2.5rem] overflow-hidden bg-gradient-to-r from-purple-600 to-indigo-700 px-6 py-20 md:px-20 text-center text-white shadow-2xl">
              ...
              <div className="relative z-10 max-w-4xl mx-auto space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-center pt-8">
                  <Link to="/signup">
                    <button className="bg-white text-purple-700 font-bold py-4 px-10 rounded-full hover:bg-gray-100 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 w-full sm:w-auto text-lg">
                ...
                <div className="pt-8 text-sm text-purple-200/80 flex justify-center gap-6">
