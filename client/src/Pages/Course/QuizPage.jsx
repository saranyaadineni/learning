                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <span>/</span>
                            <span className="text-gray-900 dark:text-white font-medium">Quiz</span>
                        </nav>
                    </motion.div>
                            ...
                            {showScore ? (
                                ...
                                >
                                    <div className="text-center space-y-6">
                                        ...
                                        >
                                            <FaTrophy className="mx-auto text-6xl text-accent-500 mb-4" />
                                        </motion.div>
                                        <h2 className="text-4xl lg:text-5xl font-bold gradient-text">Quiz Completed!</h2>
                                    ...
                                    <motion.div
                                        className="flex justify-center gap-6 pt-8 border-t border-gray-200 dark:border-gray-700"
                                        initial={{ opacity: 0, y: 20 }}
                                        animate={{ opacity: 1, y: 0 }}
                                    ...
                                    >
                                        <motion.button
                                            ...
                                            className="flex items-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                                        ...
                                        <motion.button
                                            onClick={() => navigate(-1)}
                                            className="flex items-center gap-2 bg-gray-500 hover:bg-gray-600 text-white font-semibold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                                            whileHover={{ scale: 1.05 }}
                                            whileTap={{ scale: 0.95 }}
                                        >
                                ...
                                quizzes.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-600 dark:text-gray-400 mb-8 text-lg">
                                            There are no quizzes available for this video.
                                        </p>
                                        <motion.button
                                            onClick={() => navigate(-1)}
                                            className="bg-primary hover:bg-primary-focus text-white font-semibold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                                            whileHover={{ scale: 1.05 }}
                                            whileTap={{ scale: 0.95 }}
                                        >
                                            Go Back
