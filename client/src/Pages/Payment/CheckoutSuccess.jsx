    ...
    <Layout>
      <section className="flex flex-col gap-6 items-center py-14 px-3 min-h-[100vh]">
        <div className="flex flex-col dark:bg-gray-800 bg-white gap-12 rounded-lg md:py-10 py-7 md:px-8 md:pt-3 px-3 md:w-[500px] w-full shadow-custom dark:shadow-xl transition duration-300">
          <h1 className="bg-gradient-to-r from-green-500 to-emerald-600 text-center w-full py-4 text-3xl font-inter font-bold rounded-tl-lg rounded-tr-lg text-white">
            Payment Successful
          </h1>
          ...
          <Link
            to="/"
            className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 transition-all ease-in-out duration-300 w-full py-3 text-xl font-semibold text-white text-center rounded-bl-lg rounded-br-lg"
          >
            Go to Dashboard
          </Link>
        </div>
