    ...
    <Layout>
      <section className="flex flex-col gap-6 items-center py-12 px-3 min-h-[100vh]">
        <div className="flex flex-col dark:bg-gray-800 bg-white gap-12 rounded-lg md:py-10 py-7 md:px-8 md:pt-3 px-3 md:w-[500px] w-full shadow-custom dark:shadow-xl transition duration-300">
          <h1 className="bg-gradient-to-r from-red-500 to-rose-600 text-center w-full font-inter py-4 text-3xl font-bold rounded-tl-lg rounded-tr-lg text-white">
            Payment Failed
          </h1>
          ...
          <Link
            to="/checkout"
            className="bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 transition-all ease-in-out duration-300 w-full py-3 text-xl font text-white semibold text-center rounded-bl-lg rounded-br-lg"
          >
            Try Again
          </Link>
        </div>
